...
const LANG = {
  fr: {
    ...
    onlineLeave: "QUITTER",
    onlineSearch: "RECHERCHER",
    onlineSearching: "⏳ Recherche en cours...",
    onlineInvalidCode: "Code invalide (4-6 caractères).",
    onlineReady: "Tous les joueurs sont là !",
    onlinePseudoRequired: "Entre un pseudo pour jouer en ligne",
  ...
  en: {
    ...
    onlinePseudoRequired: "Enter a name to play online",
