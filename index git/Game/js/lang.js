...
const LANG = {
  fr: {
    ...
    onlineLeaveConfirm: "Quitter la partie en ligne ?",
    pinLabel: "🔒 CODE",
    pinRequired: "Code secret : 4 chiffres requis",
    pinWrong: "Code secret incorrect pour ce pseudo",
    onlineCancelGame: "❌ ANNULER",
    onlineCancelConfirm: "Annuler cette partie ?",
  ...
  en: {
    ...
    onlineLeaveConfirm: "Leave the online game?",
    pinLabel: "🔒 CODE",
    pinRequired: "Secret code: 4 digits required",
    pinWrong: "Wrong secret code for this pseudo",
    onlineCancelGame: "❌ CANCEL",
    onlineCancelConfirm: "Cancel this game?",
