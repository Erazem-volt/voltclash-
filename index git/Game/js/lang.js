...
const LANG = {
  fr: {
    ...
    noOnlineStats: "Aucune partie en ligne jouée",
    victory: "VICTOIRE",
    ...
    onlineActions: "MODE DE JEU",
    onlineVisibility: "VISIBILITÉ",
    searchBtn: "CHERCHER",
    create2p: "2J",
    create4p: "4J",
  ...
  en: {
    ...
    noOnlineStats: "No online games played",
    victory: "VICTORY",
